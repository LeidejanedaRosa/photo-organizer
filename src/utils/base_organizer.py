...
class BaseOrganizer(ABC):
    ...
    def organize(
        ...
        self.ui_formatter.print_operation_header(self._get_operation_name(), simular)
    ...
    def _process_group(
        ...
        self.ui_formatter.print_group_header(group_name, len(images), "imagem(ns)")
    ...
    def _get_target_directory(self, base_directory: str, group_name: str) -> str:
